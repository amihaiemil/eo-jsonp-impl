...
sed -i "s/<a.*>fat<\/a>/<a href=\"https:\/\/oss\.sonatype\.org\/service\/local\/repositories\/releases\/content\/com\/amihaiemil\/web\/eo-jsonp-impl\/${tag}\/eo-jsonp-impl-${tag}-jar-with-dependencies\.jar\">fat<\/a>/" README.md
